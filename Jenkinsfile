            ...
            steps {
                ...
                script {
                    if (isUnix()) {
                        ...
                        // 1) Use existing environment variable if already set (global agent property)
                        if (env.ANDROID_HOME) {
                        ...
                        if (!detectedAndroidHome) {
                            error "Android SDK not found. Please set ANDROID_HOME in Jenkins global properties or install Android SDK on the agent."
                        }
